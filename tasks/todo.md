...
| 東浪見 | 35.33, 140.398 | 35.3502, 140.3925 | 2.35km | 東浪見 | 移設：登録値はいすみ市岬町中原(太東)。サンライズと志田下の間へ |
...
東浪見は、住所で確定したサンライズ `35.3563` と志田下 `35.3456` の中間にあたる
`35.3510` から方位105°で汀線へ出し、`35.3502, 140.3925`（逆ジオコーディングで「東浪見」）とした。
**これは住所の裏付けが無く、両隣に挟んだ推定である。** 花籠ポイントと並んで、
33件のうち推定のまま残っている2件目。
...
| 東浪見 | 35.3502, 140.3925 | 105 | 0.68km | 1 |
| 釣ヶ崎（志田下） | 35.3456, 140.3931 | 100 | 0.51km | 2 |
| 太東 | 35.2923, 140.4072 | 110 | 6.07km | 2 |
...
西へ10m寄せて `140.3918` にした。他の32件と同じく陸側に揃えている。
