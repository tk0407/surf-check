...
| サンライズ（白里） | 35.46, 140.458 | 35.4842, 140.4224 | 5.04km | 南今泉 | 移設：登録値は白子町牛込の沖。ユーザー提供の住所（大網白里市南今泉4881-1 地先）を番地で座標化 |
...
- **サンライズ（白里）（確定）** — ユーザーから住所をもらった。
  〒299-3202 千葉県大網白里市南今泉4881-1 地先。登録名の「（白里）」どおり白里海岸で正しく、
  Surfers Ocean の一宮町東浪見の「サンライズ」とは別ポイント。
  自分は大字「南今泉」の代表点から真東へ出したため隣の「北今泉」の汀線に着いていた。
  4881番地を座標化すると `35.4842, 140.418732` で、そこから東へ0.45km出た
  `35.4842, 140.4224`（逆ジオコーディングで「南今泉」）を採用した。
